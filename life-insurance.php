...
<html lang="en">
   <head>
      <!--website title-->
      <title><?php echo SiteName; ?> - Life Insurance That Fits Your Needs</title>
      <!--seo-meta-tag-->
      <meta charset="UTF-8">
            ...
            <div class="row">
               <div class="col-lg-6 v-center">
                  <div class="header-heading">
                     <h1 data-aos="zoom-out-up">Protect the ones you love with Life Insurance</h1>
                     <p data-aos="zoom-out-up" data-aos-delay="400">Add more security to your financial future with life insurance. Join thousands who turn to PremiumInsurancePolicy.com every month for life insurance quotes and information about options to help protect their families’ financial future.</p>
               ...
               <div class="col-lg-8 pl0 m-mt30" id="form">
                  <div class="form-block">
                     <div class="form-header">
                        <h2><span>get an auto life insurance quote</span></h2>
            ...
            <div class="row m-text-c">
               <div class="col-lg-6 v-center">
                  <div class="about-company">
                     ...
                     <p data-aos="fade-up" data-aos-delay="300">Life insurance is a contract in which a policyholder pays regular premiums in exchange for a lump-sum death benefit may be paid to the policyholder's beneficiaries. The lump-sum benefit is paid when the policyholder either passes away or a specific amount of time has passed. Life insurance policies can help provide financial security by replacing lost income and covering expenses.</p>
            ...
            <div class="row justify-content-center text-center">
               <div class="col-lg-8">
                  <div class="cta-heading">
                     <h2 class="mb20 text-w" data-aos="fade-up" data-aos-delay="100">get a quick, personalized Life insurance quote today</h2>
                     <p class="text-w" data-aos="fade-up" data-aos-delay="300">A great rate on Life insurance is just a few clicks away. Start your free quote online.</p>
                     <a href="#form" class="btn-rd mt40" data-aos="fade-up" data-aos-delay="500">Get your Quote →</a>
                  </div>
               </div>
            </div>
