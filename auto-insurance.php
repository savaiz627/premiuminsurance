...
<html lang="en">
   <head>
      <!--website title-->
      <title><?php echo SiteName; ?> - Auto Insurance That Fits Your Needs</title>
      <!--seo-meta-tag-->
      <meta charset="UTF-8">
            ...
            <div class="row">
               <div class="col-lg-6 v-center">
                  <div class="header-heading">
                     <h1 data-aos="zoom-out-up">Fast & Free Car Insurance Quotes</h1>
                     <p data-aos="zoom-out-up" data-aos-delay="400">A policy with PremiumInsurancePolicy.com is more than just car insurance. It's personalized help from agents and innovative tools—like PremiumInsurancePolicy.com—that help keep you driving forward. Get a car insurance quote and learn why millions of households trust PremiumInsurancePolicy.com for their insurance needs.</p>
                  ...
                  <div class="key-features itm-media-object mt60">
                     <div class="media" data-aos="fade-In" data-aos-delay="100">
                        ...
                        <div class="media-body">
                           ...
                           <p>See all the different ways PremiumInsurancePolicy.com can help protect your car.</p>
                        </div>
                     </div>
                     <div class="media mt30" data-aos="fade-In" data-aos-delay="300">
                        ...
                        <div class="media-body">
                           ...
                           <p>Learn how you can save on car insurance by browsing discounts.</p>
                        </div>
                     </div>
               ...
               <div class="col-lg-8 pl0 m-mt30" id="form">
                  <div class="form-block">
                     <div class="form-header">
                        <h2><span>get an auto insurance quote</span></h2>
                        <p>Affordable auto insurance on and off the road.</p>
                     </div>
            ...
            <div class="row m-text-c">
               <div class="col-lg-6 v-center">
                  <div class="about-company">
                     <h2 class="mb20" data-aos="fade-up" data-aos-delay="100">Save <em>Upto 90%</em> with Best Insurance Plans offered by PremiumInsurancePolicy.com</h2>
                     <p data-aos="fade-up" data-aos-delay="300">Car insurance can help protect you from expensive, sometimes devastating surprises. Let's say you're in a covered accident. As an insured driver, you can get help paying medical bills, repairs, certain legal defense costs and more. Select your car's make and model to find discounts, safety ratings and insurance information for cars, trucks, electric vehicles and more.</p>
            ...
            <div class="row">
               <div class="col-lg-5 v-center">
                  <div class="common-heading m-text-c pr50">
                     <h2 class="mb20" data-aos="fade-up" data-aos-delay="100">how to  <em>compare car insurance quotes</em> Works?</h2>
                     <p data-aos="fade-up" data-aos-delay="300">To accurately compare auto quotes across insurers, you'll want to select the same set of coverages, limits and deductibles for each quote.</p>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="steps-div sd1 mt30" data-aos="fade-up" data-aos-delay="100">
                           ...
                           <h4 class="mb10">Choose your coverage</h4>
                           <p>Consider your state's requirements and any specific coverage types you might want, like collision or comprehensive.</p>
                        </div>
                        <div class="steps-div sd2 mt30" data-aos="fade-up" data-aos-delay="500">
                           ...
                           <h4 class="mb10">Consider your limits</h4>
                           <p>Think about your personal needs as well as state laws when choosing your coverage limits.</p>
                        </div>
                     </div>
                     <div class="col-lg-6 mt60 m-m0">
                        <div class="steps-div sd3 mt30" data-aos="fade-up" data-aos-delay="300">
                           ...
                           <h4 class="mb10">Select your deductible</h4>
                           <p>Coverage can come with a deductible, or the amount you'll pay toward a claim.</p>
                        </div>
            ...
            <div class="row justify-content-center text-center">
               <div class="col-lg-8">
                  <div class="cta-heading">
                     <h2 class="mb20 text-w" data-aos="fade-up" data-aos-delay="100">get a quick, personalized car insurance quote today</h2>
                     <p class="text-w" data-aos="fade-up" data-aos-delay="300">A great rate on auto insurance is just a few clicks away. Start your free quote online.</p>
                     <a href="#form" class="btn-rd mt40" data-aos="fade-up" data-aos-delay="500">Get your Quote →</a>
                  </div>
               </div>
            </div>
